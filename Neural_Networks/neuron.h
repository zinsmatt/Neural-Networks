...
class Neuron
{
    vector<double> weights;         // weights associated with this neuron
    vector<double> inputs;          // inputs of this neuron
    ...
    NeuralLayer& neuralLayer;       // neural layer corresponding
...
public:
     ...
     */
    void setInputs(const vector<double>& values) { inputs = values; }

    /**
     * @brief getArrayInputs
     * @return  array of inputs
     */
    const vector<double>& getInputs() const { return inputs; }
     ...
     * @return the output
     */
    double calc(const vector<double>& _inputs) const;
     ...
     */
    double derivative(const vector<double>& _inputs) const;
     ...
     */
    vector<double> calcBatch(const vector<vector<double>>& _inputs) const;
     ...
     */
    vector<double> derivativeBatch(const vector<vector<double>>& _inputs) const;
